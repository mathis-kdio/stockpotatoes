		...
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			<header class="mdl-layout__header">
    			<div class="mdl-layout__header-row">
      				<span class="mdl-layout-title">Espace Enseignant</span>    
     		 		<div class="mdl-layout-spacer"></div>
      				<nav class="mdl-navigation mdl-layout--large-screen-only">
        				<a class="mdl-navigation__link" href="http://martonne.net/anglais/index.php">Page d'accueil</a>
        				<a class="mdl-navigation__link" href="http://martonne.net/anglais/stockpotatoes">Stockpotatoes</a>
        				<a class="mdl-navigation__link" href="http://martonne.net/anglais/stockpotatoes/login_eleve.php">Login élève</a>
        				<a class="mdl-navigation__link" href="../administrateur/login_administrateur.php">Login Administrateur</a>
        				<a class="mdl-navigation__link" href="../upload/upload.php">Ajouter un exercice</a>
      				</nav>
    			</div>
  			</header>
