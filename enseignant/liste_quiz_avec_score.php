...
<html>
<head>
<title>Liste des exercices avec enregistrement</title>
...
<p><strong><a href="../index.php">Accueil Stockpotatoes</a> - </strong><strong><a href="accueil_enseignant.php">Espace enseignant</a> - Liste des 
  exercices param&eacute;tr&eacute;s avec enregistrement du r&eacute;sultat</strong></p>
<p align="right">&nbsp;</p>
...
?>
      ...
      <td width="46%"><input type="submit" name="Submit" value="Valider"></td>
    </tr>
  </table>
</form>
...
<table border="1">
  <tr> 
    ...
    <td bgcolor="#cccc99"><div align="center"><strong>En entrainement</strong></div></td>
