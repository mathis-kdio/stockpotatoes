...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form4")) {
  ...
  $updateSQL = sprintf("UPDATE stock_quiz SET titre=%s, niveau_ID=%s, theme_ID=%s ,auteur=%s, en_ligne=%s, avec_score=%s, evaluation_seul=%s, cat_doc=%s, type_doc=%s  WHERE ID_quiz=%s",
					   ...
					   GetSQLValueString($_POST['type_doc'], "int"),
...
<html>
<head>
<title>Mise &agrave; jour d'une fiche document</title>
...
<p><strong><a href="../index.php">Accueil Stockpotatoes</a> - </strong><strong><a href="accueil_enseignant.php">Espace 
  Enseignant</a></strong> - <strong>Mise &agrave; jour d'une fiche document </strong></p>
<table width="100%" border="0" cellspacing="10" cellpadding="0">
  <tr valign="top"> 
    <td width="28%"><img src="../patate.gif" width="253" height="227"></td>
    <td width="72%" valign="middle"> <form name="form4" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="100%" border="1" cellspacing="10" cellpadding="0">
          <tr> 
            <td><div align="right">
              <p><strong>N&deg; <?php echo $row_RsChoixQuiz['ID_quiz']; ?></strong>
			  </p>
              </div></td>
            <td class="retrait20"><strong><?php echo $row_RsMatiere['nom_mat']; ?>
            </strong></td>
          </tr>
          <tr>
...
Autres Ex./TP</label></td>
      ...
      Annexes</label></td>
          ...
          <tr>
            <td><div align="right"><strong>Nature du document</strong></div></td>
            <td class="retrait20"><select name="type_doc" size="1" id="type_doc">

              <option value="4" <?php if (!(strcmp(4, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Page Web</option>
              <option value="5" <?php if (!(strcmp(5, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Document Word</option>
              <option value="6" <?php if (!(strcmp(6, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Document Excel</option>
              <option value="7" <?php if (!(strcmp(7, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Document Powerpoint</option>
              <option value="8" <?php if (!(strcmp(8, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Document Pdf</option>
              <option value="9" <?php if (!(strcmp(9, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Pr&eacute;sentation OpenOffice</option>
              <option value="10" <?php if (!(strcmp(10, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Trait. Texte OpenOffice</option>
              <option value="11" <?php if (!(strcmp(11, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Tableur Open Office</option>
              <option value="12" <?php if (!(strcmp(12, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Image fixe</option>
              <option value="13" <?php if (!(strcmp(13, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Animation</option>
              <option value="14" <?php if (!(strcmp(14, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Audio</option>
              <option value="15" <?php if (!(strcmp(15, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Vid&eacute;o</option>
			  <option value="2" <?php if (!(strcmp(2, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Document Hotpotatoes</option>
              <option value="16" <?php if (!(strcmp(16, $row_RsChoixQuiz['type_doc']))) {echo "SELECTED";} ?>>Autre</option>
            </select></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td> <input <?php if (!(strcmp($row_RsChoixQuiz['en_ligne'],"O"))) {echo "checked";} ?> name="en_ligne" type="checkbox" id="en_ligne" value="O">
              <font color="#990000"><em><font color="#990000"><em><font color="#990000"><em>Le document peut &ecirc;tre vu sans que l'&eacute;l&egrave;ve soit identifi&eacute;. </em></font></em></font></em></font></td>
          </tr>
          <tr> 
            ...
            <td> <input <?php if (!(strcmp($row_RsChoixQuiz['avec_score'],"O"))) {echo "checked";} ?> name="avec_score" type="checkbox" id="avec_score" value="O">
              <em><font color="#990000"><em><font color="#990000"><em><font color="#990000"><em>Le document peut &ecirc;tre vu</em></font></em></font></em></font><font color="#990000"><em><font color="#990000"><em> par l'&eacute;l&egrave;ve en s'identifiant</em></font> .</em></font></em></td>
          </tr>
<tr> 
            ...
            <em><font color="#990000"><em><font color="#990000"><em><em>En mode &eacute;valuation, <font color="#990000"><em><font color="#990000"><em><font color="#990000"><em>le document ne pourra &ecirc;tre vu</em></font></em></font></em></font> qu'une seule fois</em></em></font></em></font></em></td>
          </tr>
        </table>
        <blockquote> 
          <p align="center"> 
