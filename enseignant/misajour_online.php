...
<table width="100%" border="0" cellspacing="10" cellpadding="0">
  <tr valign="top"> 
    <td width="28%"><p><img src="../patate.gif" width="253" height="227"></p>
    <p>&nbsp;</p>
	<form name="form2" style="margin:0px" method="post" action="../upload/modifier_online.php">
              <div align="center">
                <input name="ID_quiz" type="hidden" id="ID_quiz" value="<?php echo $row_RsChoixQuiz['ID_quiz']; ?>">
                <input name="matiere_ID" type="hidden" id="matiere_ID" value="<?php echo $row_RsMatiere['ID_mat']; ?>">
...
?>
      ...
      Annexes</label></td>
          ...
          <tr>
            ...
            <td class="retrait20">Page Web r&eacute;alis&eacute;e avec l'&eacute;diteur en ligne   </td>
          </tr>
          <tr> 
