  ...
  <tr valign="top"> 
    ...
    <td> <table border="1" align="center" >
        ...
        <tr> 
          ...
          <td class="retrait20"><a href="../choix_quiz.php?VAR_fichier=<?php echo $row_rsListeSelectMatiereNiveau['fichier']; ?>&VAR_ID_quiz=<?php echo $row_rsListeSelectMatiereNiveau['ID_quiz']; ?>&VAR_nom_mat=<?php echo $row_rsChoix['nom_mat']; ?>"><strong><?php echo $row_rsListeSelectMatiereNiveau['titre']; ?></strong></a></td>
          ...
          <td class="retrait20"><form name="form2" style="margin:0px" method="post" action="ajout_fichiers_joints.php">
