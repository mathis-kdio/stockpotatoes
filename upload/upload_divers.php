...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><strong><a href="../index.php">Accueil Stockpotatoes</a> - Espace Upload 
      - Envoyer un document sur le serveur</strong></td>
    <td><div align="right">
      </div></td>
  </tr>
</table>
...
<form method="post" enctype="multipart/form-data" name="form1" id="formulaire" action="upload_divers.php">
  <table align="center">
    ...
    <tr valign="baseline"> 
      <td nowrap align="right">
      	Ce fichier est relatif à l'étude de la catégorie<strong>Le thème au dessus doit être le même</strong>
      </td>
      <td>
    ...
    <tr valign="baseline">
      <td nowrap align="right">Nature du document </td>
      <td><select name="type_doc" size="1" id="type_doc">
        ...
        <option value="9">Pr&eacute;sentation OpenOffice</option>
        ...
        <option value="15">Vid&eacute;o</option>
    ...
    <tr valign="baseline"> 
      ...
      <td><em> 
        ...
        <font color="#990000"><em><font color="#990000"><em><font color="#990000"><em>Le document peut &ecirc;tre vu</em></font></em></font></em></font><font color="#990000"><em><font color="#990000"><em> par l'&eacute;l&egrave;ve en s'identifiant</em></font> .</em></font></em></td>
    </tr>
    <tr valign="baseline"> 
	  <td nowrap align="right">Une seule consultation </td>
      <td><em>
<input name="evaluation_seul" type="checkbox" id="evaluation_seul" value="O">
        <font color="#990000"> <em> <font color="#990000"><em><em>En mode &eacute;valuation, <font color="#990000"><em><font color="#990000"><em><font color="#990000"><em>le document ne pourra &ecirc;tre vu</em></font></em></font></em></font> qu'une seule fois</em></em></font></em></font></em></td>
    </tr>
    <tr valign="baseline"> 
    ...
    <tr valign="baseline"> 
      <td nowrap align="right">&nbsp;</td>
      <td><input name="submit2" type="submit" value="Envoyer votre document sur le serveur"></td>
    </tr>
  </table>
