...
<form method="post" enctype="multipart/form-data" name="form1" id="formulaire" action="upload_url.php">
  <table align="center">
    ...
    <tr valign="baseline"> 
      <td width="212" align="right" nowrap>
      	Lien est relatif à l'étude de la catégorie: <strong>Le thème au dessus doit être le même</strong>
    	</td>
      <td width="350">
      	<select name="categorie_ID" id="select">
          <option value="value">Selectionnez une categorie: Le thème au dessus doit être le même</option>
          <?php
          do
          {
